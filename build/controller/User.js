...
var UserCallback = /** @class */ (function () {
    ...
    UserCallback.getInfo = function (req, res) {
        var _a, _b;
        return __awaiter(this, void 0, void 0, function () {
            var token, data, payload, err_2;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, models_1.UserModel.findOne({ _id: data.user.uid }).select('email _id name phone address created')];
                    case 1:
                        payload = _c.sent();
    ...
    UserCallback.searchUser = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var authHeader, token, decodedToken_1, name, users, newArr, err_3;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                    ...
                    case 2:
                        err_3 = _a.sent();
                        console.error(err_3); // log the error for debugging purposes
    ...
    UserCallback.create = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, email, name, password, avatarUrl, phone, address, typeAccount, payload, err_5;
    ...
    UserCallback.update = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var id, _a, name, password, phone, address, avatarUrl, typeAccount, payload, err_6;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 2, , 3]);
