...
var CommentCallback = /** @class */ (function () {
    function CommentCallback() {
    }
    CommentCallback.get = function (req, res) {
    ...
    CommentCallback.getOne = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    CommentCallback.create = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, comment, userId, postId, countLikes, replyForCommentId, countDisLikes, countShare, payload, err_3;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 2, , 3]);
                        _a = req.body, comment = _a.comment, userId = _a.userId, postId = _a.postId, countLikes = _a.countLikes, replyForCommentId = _a.replyForCommentId, countDisLikes = _a.countDisLikes, countShare = _a.countShare;
    ...
    CommentCallback.update = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, name, description, image, id, price, category, isActive, payload, err_4;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 2, , 3]);
    ...
    CommentCallback.delete = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var productID, payload, err_5;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
...
exports.default = CommentCallback;
