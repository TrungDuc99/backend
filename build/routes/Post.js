...
PostRouter.get('/posts', AuthenticateToken_1.authenticateToken, Post_1.default.get);
...
PostRouter.get('/postbyuser/:id', AuthenticateToken_1.authenticateToken, Post_1.default.getPostByUserId);
